...
<script>
    ...
    function validate(){
        ...
        if(regx.test(num)){
            if(isFinite(amount) == true){
				...
				document.getElementById("mobile").style.border = "2px solid blue";
                return true;
			}
			else{
				document.getElementById("mobileval").style.visibility  = "hidden";
	...
	function validateifsc(){
		...
		if(regx2.test(ifsc)){
			...
			document.getElementById("ifsc").style.border = "2px solid blue";
			return true;
		}
		else{
...
<form onsubmit = "return validate() && validateifsc();" method = "POST" action = "financeupdate.php">
...
<input type="text" id="uname"  name="name" value="<?php echo $row['Name'];?>" required/><br><br>

<label for="id" >ID Number</label><br>
<input type="text" min="1" max="50" step="1" class="input" id="id" name="id" value="<?php echo $row['ID'];?>" /><br><br>

<label for="mobile">Mobile number</label><br>
<input type="text" min="1" id="mobile" name="mobile" onchange="return validate();" value="<?php echo $row['Mobile'];?>" /><br>
...
<p style = "margin-left: 27%;font-size:18px;font-family: 'Brush Script MT', cursive;color: rgba(1, 27, 50);">Are you tested positive for covid?</p>
...
<p style = "margin-left: 27%;font-size:18px;font-family: 'Brush Script MT', cursive;color: rgba(1, 27, 50);">Are your family members affected?</p>
...
<input type="text" id="amt" name = "amount" value="<?php echo $row['Expectedamount'];?>" /><br>
...
<input type="text" id="ifsc" name="ifsc" onchange="return validateifsc();" value="<?php echo $row['IFSC'];?>" /><br>
