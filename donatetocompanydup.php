...
<html>
    ...
    <div class = "formcontainer">
        <marquee style = "font-family: 'Brush Script MT', cursive;font-size: 16px;color: red;">Donating amount will be deducted from your salary. No need to pay to the company account.</marquee>
        <form onsubmit = "return validate();" method = "POST" action = "donatetocompanyresponsedup.php">
            <h2 style = "text-align: center;font-family: 'Brush Script MT', cursive;color: rgba(1, 27, 50);border-bottom: 2px solid rgba(1, 27, 50);margin-top: 20px;padding-bottom: 10px;">FORM</h2>
            <label for = "name">Name</label><br>
            <input type = "text" name = "name" value = "<?php echo $curr_name;?>" required/><br><br>

           <!-- <label for = "age">Age</label><br>
            <input type = "text" name = "age" required /><br><br> -->
            
            <label for = "id">ID Number</label><br> 
            <input type = "text" name = "id" value = "<?php echo $curr_id;?>" required/><br><br>
            
            <label for = "mobile">Mobile Number</label><br>
            <input type = "text" id = "mobile" name = "mobile" value = "<?php echo $curr_mobile;?>" required/><br>
            ...
            <input id = "amt" type = "text" name = "amount" value = "<?php echo $curr_amount;?>"  required/><br>
